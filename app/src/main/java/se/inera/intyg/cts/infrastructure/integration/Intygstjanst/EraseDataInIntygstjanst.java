...
public class EraseDataInIntygstjanst implements EraseDataInService {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(EraseDataInIntygstjanst.class);
  private static final ServiceId SERVICE_ID = new ServiceId("intygstjanst");
